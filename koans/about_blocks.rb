...
class AboutBlocks < Neo::Koan
  ...
  def method_with_block_arguments
    yield("Jim") # The yield keyword — in association with a block — allows to pass a set of additional instructions during a method invocation.
  end
  ...
  def test_methods_can_call_yield_many_times
    result = []
    many_yields { |item| result << item } # for each item which are yields in this case, push each one into the result array (<< push)
